...
const Vorstellung = () => {
  return (
    <div className='jg__vorstellung section__padding' id='vorstellung'>
      <div className='jg__vorstellung-content'>
        ...
        <p> Ich bin Jamila Gränzer, Informatikstudentin des FB5 der Hochschule Anhalt.
            ...
            Derzeit gibt es Prozesse in der Hochschule, die für Studierende nicht transparent sind, obwohl diese die Existenz von Studiengängen und Fachbereichen betreffen.
            Das finde ich inakzeptable.
            </p>
      </div>
